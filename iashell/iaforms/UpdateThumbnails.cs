    ...
    public class UpdateThumbnails
    {
        ...
        public static async void runDcraw(string exePath, string inputImagePath, string outputImagePath)
        {
            ...
            using (Process exeProcess = Process.Start(startInfo))
            {
                ...
                Debug.WriteLine("arguments {0}", startInfo.Arguments);
                Debug.WriteLine("stdout {0}", stdout);
                Debug.WriteLine("stderr {0}", stderr);
                Debug.WriteLine("Exit code : {0}", exeProcess.ExitCode);
            }
