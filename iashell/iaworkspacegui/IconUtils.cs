    ...
    class IconUtils
    {
        ...
        public static System.Drawing.Image PadImage(System.Drawing.Image originalImage, string rating)
        {
            ...
            using (Graphics graphics = Graphics.FromImage(squareImage))
            {
                ...
                DrawCheckin(graphics, CheckedType.EditedChkOut);
        ...
        static public async void makeThumbnailsThreadFunc(string workingPath, string inputImagePath, string imageName)
        {
